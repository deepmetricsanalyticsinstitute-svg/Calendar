...
const Calendar: React.FC<CalendarProps> = ({ currentDate, onDayClick, reminders }) => {
      ...
      <div className="grid grid-cols-7 gap-2 text-sm sm:text-base">
        ...
        {calendarDays.map((day, index) => (
          <div
            key={index}
            className={`
              relative w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center rounded-full
